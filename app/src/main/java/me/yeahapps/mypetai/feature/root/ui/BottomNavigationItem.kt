...
sealed class BottomNavigationItem(val route: String, @DrawableRes val icon: Int, @StringRes val label: Int) {
    ...
    data object Create : BottomNavigationItem("create", R.drawable.ic_create, R.string.create_label)
    data object Profile : BottomNavigationItem("profile", R.drawable.ic_profile,R.string.profile_label)
}